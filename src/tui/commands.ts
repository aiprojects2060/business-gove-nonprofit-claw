...
export function getSlashCommands(options: SlashCommandOptions = {}): SlashCommand[] {
  ...
  const commands: SlashCommand[] = [
    ...
    { name: "fleet", description: "Show all agents and their status" },
    { name: "broadcast", description: "Send message to all agents" },
    { name: "task", description: "Send task to specific agent: /task <agent-id> <message>" },
...
export function helpText(options: SlashCommandOptions = {}): string {
  ...
  return [
    ...
    "",
    "Multi-agent:",
    "/fleet              Show all agents and their status",
    "/broadcast <msg>    Send message to all agents",
    "/task <id> <msg>    Send task to specific agent",
    "",
    "/new or /reset",
    "/abort",
    "/settings",
